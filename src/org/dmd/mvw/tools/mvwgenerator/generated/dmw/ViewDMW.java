...
import org.dmd.dms.generated.dmo.MetaDMSAG;                                             // Attribute extendsInterface from the meta schema - (BaseDMWGenerator.java:910)
...
import org.dmd.mvw.tools.mvwgenerator.extended.Event;                                   // Is reference type - (BaseDMWGenerator.java:997)
import org.dmd.mvw.tools.mvwgenerator.extended.MvwDefinition;                           // Derived class - (BaseDMWGenerator.java:1138)
import org.dmd.mvw.tools.mvwgenerator.extended.RunContextItem;                          // Is reference type - (BaseDMWGenerator.java:997)
import org.dmd.mvw.tools.mvwgenerator.extended.View;                                    // Required for getModificationRecorder() - (BaseDMWGenerator.java:953)
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.EventDMO;                           // For multi-valued adds of Event - (BaseDMWGenerator.java:1657)
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.MvwDMSAG;                           // Attribute broadcast from the mvw schema - (BaseDMWGenerator.java:910)
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.RunContextItemDMO;                  // For multi-valued adds of RunContextItem - (BaseDMWGenerator.java:1657)
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.ViewDMO;                            // Class not auxiliary or abstract - (BaseDMWGenerator.java:1142)
import org.dmd.mvw.tools.mvwgenerator.generated.dmw.DisplayDataSpecIterableDMW;         // For multi-valued DisplayDataSpec - (BaseDMWGenerator.java:1993)
import org.dmd.mvw.tools.mvwgenerator.generated.dmw.EventIterableDMW;                   // For multi-valued Event - (BaseDMWGenerator.java:1599)
import org.dmd.mvw.tools.mvwgenerator.generated.dmw.EventSpecIterableDMW;               // For multi-valued EventSpec - (BaseDMWGenerator.java:1993)
import org.dmd.mvw.tools.mvwgenerator.generated.dmw.MethodWithArgsIterableDMW;          // For multi-valued MethodWithArgs - (BaseDMWGenerator.java:1993)
import org.dmd.mvw.tools.mvwgenerator.generated.dmw.OperationSpecIterableDMW;           // For multi-valued OperationSpec - (BaseDMWGenerator.java:1993)
import org.dmd.mvw.tools.mvwgenerator.generated.dmw.RunContextItemIterableDMW;          // For multi-valued RunContextItem - (BaseDMWGenerator.java:1599)
import org.dmd.mvw.tools.mvwgenerator.generated.types.DisplayDataSpec;                  // Primitive type - (BaseDMWGenerator.java:1040)
import org.dmd.mvw.tools.mvwgenerator.generated.types.EventSpec;                        // Primitive type - (BaseDMWGenerator.java:1040)
import org.dmd.mvw.tools.mvwgenerator.generated.types.OperationSpec;                    // Primitive type - (BaseDMWGenerator.java:1040)
import org.dmd.mvw.tools.mvwgenerator.types.MethodWithArgs;                             // Primitive type - (BaseDMWGenerator.java:1040)
