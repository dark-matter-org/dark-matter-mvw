...
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.PropertyAccessGeneratorDMO; // primitive type
...
public class PropertyAccessGeneratorREF extends DmcNamedObjectNontransportableREF<PropertyAccessGeneratorDMO> {
    ...
    public PropertyAccessGeneratorREF(){
    }

    public PropertyAccessGeneratorREF(PropertyAccessGeneratorDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }

    public PropertyAccessGeneratorREF(CamelCaseName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__camelCaseName);
         myName.set(n);
    }

    public PropertyAccessGeneratorREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__camelCaseName);
         myName.set(n);
    }

    public PropertyAccessGeneratorREF(PropertyAccessGeneratorREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(PropertyAccessGeneratorDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public PropertyAccessGeneratorREF cloneMe(){
