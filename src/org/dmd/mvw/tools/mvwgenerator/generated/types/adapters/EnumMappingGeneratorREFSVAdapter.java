...
import org.dmd.mvw.tools.mvwgenerator.generated.types.DmcTypeEnumMappingGeneratorREFSV;

@SuppressWarnings("serial")
// org.dmd.dms.util.AdapterFormatter.dumpAdapter(AdapterFormatter.java:59)
// Called from: org.dmd.dms.util.AdapterFormatter.dumpAdapterSV(AdapterFormatter.java:12)
public class EnumMappingGeneratorREFSVAdapter extends DmcTypeEnumMappingGeneratorREFSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeEnumMappingGeneratorREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
