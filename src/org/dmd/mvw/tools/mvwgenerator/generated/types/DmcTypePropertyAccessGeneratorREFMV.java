...
/**
 * The DmcTypePropertyAccessGeneratorREFMV provides storage for a multi-valued PropertyAccessGeneratorREF
 * <P>
...
public class DmcTypePropertyAccessGeneratorREFMV extends DmcTypePropertyAccessGeneratorREF implements Serializable {
    ...
    private final static Iterator<PropertyAccessGeneratorREF> emptyList = (new ArrayList<PropertyAccessGeneratorREF>()).iterator();
    
    protected ArrayList<PropertyAccessGeneratorREF> value;
    
    public DmcTypePropertyAccessGeneratorREFMV(){
    
    }
    
    public DmcTypePropertyAccessGeneratorREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypePropertyAccessGeneratorREFMV getNew(){
        return(new DmcTypePropertyAccessGeneratorREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<PropertyAccessGeneratorREF> cloneIt(){
        synchronized(this){
            DmcTypePropertyAccessGeneratorREFMV rc = getNew();
    ...
    public PropertyAccessGeneratorREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<PropertyAccessGeneratorREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public PropertyAccessGeneratorREF del(Object v){
        synchronized(this){
            ...
            PropertyAccessGeneratorREF key = null;
    ...
    public Iterator<PropertyAccessGeneratorREF> getMV(){
        synchronized(this){
            ...
            ArrayList<PropertyAccessGeneratorREF> clone = new ArrayList<PropertyAccessGeneratorREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2464)
    public ArrayList<PropertyAccessGeneratorREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<PropertyAccessGeneratorREF>());
            else 
                return(new ArrayList<PropertyAccessGeneratorREF>(value));
        }
    }
    ...
    public PropertyAccessGeneratorREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public PropertyAccessGeneratorREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<PropertyAccessGeneratorREF>(getAttributeInfo().indexSize);
