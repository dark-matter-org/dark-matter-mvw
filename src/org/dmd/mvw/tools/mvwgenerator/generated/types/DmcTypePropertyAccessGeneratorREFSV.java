...
/**
 * The DmcTypePropertyAccessGeneratorREFSV provides storage for a single-valued PropertyAccessGeneratorREF
 * <P>
...
public class DmcTypePropertyAccessGeneratorREFSV extends DmcTypePropertyAccessGeneratorREF implements Serializable {
    ...
    protected PropertyAccessGeneratorREF value;
    
    public DmcTypePropertyAccessGeneratorREFSV(){
    
    }
    
    public DmcTypePropertyAccessGeneratorREFSV(DmcAttributeInfo ai){
        super(ai);
    }
    
    public DmcTypePropertyAccessGeneratorREFSV getNew(){
        return(new DmcTypePropertyAccessGeneratorREFSV(getAttributeInfo()));
    }
    
    public DmcTypePropertyAccessGeneratorREFSV getNew(DmcAttributeInfo ai){
        return(new DmcTypePropertyAccessGeneratorREFSV(ai));
    }
    
    @Override
    // org.dmd.dms.util.GenUtility.dumpSVType(GenUtility.java:2183)
    public DmcAttribute<PropertyAccessGeneratorREF> cloneIt(){
        DmcTypePropertyAccessGeneratorREFSV rc = getNew();
        rc.value = value;
        return(rc);
    }
    
    // org.dmd.dms.util.GenUtility.dumpSVType(GenUtility.java:2194)
    public PropertyAccessGeneratorREF getSVCopy(){
        if (value == null)
            return(null);
    ...
    public PropertyAccessGeneratorREF set(Object v) throws DmcValueException {
    ...
    @Override
    public PropertyAccessGeneratorREF getSV(){
        return(value);
    }
