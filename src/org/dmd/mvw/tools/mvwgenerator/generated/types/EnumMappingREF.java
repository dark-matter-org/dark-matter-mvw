...
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.EnumMappingDMO; // primitive type
...
public class EnumMappingREF extends DmcNamedObjectNontransportableREF<EnumMappingDMO> {
    ...
    public EnumMappingREF(){
    }

    public EnumMappingREF(EnumMappingDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }

    public EnumMappingREF(CamelCaseName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__mappingName);
         myName.set(n);
    }

    public EnumMappingREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__mappingName);
         myName.set(n);
    }

    public EnumMappingREF(EnumMappingREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(EnumMappingDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }
