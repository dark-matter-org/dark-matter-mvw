...
public class DmpServerSchemaAG extends SchemaDefinition {
    ...
    private void initialize() throws DmcValueException {
        if (instance == null){
            ...
            me.setFile("/src/org/dmd/dmp/server/servlet/dmdconfig/dmp.server.dms");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _PluginConfigOBJ.setDescription("The PluginConfig is used to specify a plugin to be loaded into\n the DMP Servlet Reference Implementation servlet.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _UserRIOBJ.setDescription("The UserRI class provides a user representation for use with the \n Reference Implementation (RI).");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _pluginClassOBJ.setDescription("The fully qualified name of the class derived from DmpServletPlugin\n that implements a plugin's behaviour.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _useSchemaClassOBJ.setDescription("The fully qualified name of a schema class to be loaded on behalf\n of a plugin.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _runnableOBJ.setDescription("A flag to indicate if a plugin implements Runnable. If so, once all plugins\n have been initialized, the runnable plugins will be started.");
