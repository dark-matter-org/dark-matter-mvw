...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _MvwDefinitionOBJ.setDescription("The MvwDefinition class provide a common base for all MVW definition\n classes.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _EventOBJ.setDescription("The specification of an Event definition will result in the creation of\n a gwtEvent and its associated handler interface.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _ModuleOBJ.setDescription("The Module is used to define a reusable set of MVW functionality which\n can be referred to in Application definitions or other Module definitions.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _ViewOBJ.setDescription("The View is used to define the aspects of two kinds of interfaces that\n define the functionality provided by a view of a model; the event interface and the \n data interface.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _RunContextItemOBJ.setDescription("The RunContextItem allows for the generation of an overall RunContext for\n a WebApplication or WebSite.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _WebApplicationOBJ.setDescription("The WebApplication definition allows for the definition of the superstructure\n for an application, basically it's the definition of the overall application controller.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _I18NConfigOBJ.setDescription("The I18NConfig is a specialized RunContextItem that indicates an interface\n class used to access internationalized constants or messages.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _MenuElementDefinitionOBJ.setDescription("The MenuElementDefinition is common base for all definitions associated with\n the definition of menu elements.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _MenuOBJ.setDescription("The Menu is a common base for all definitions associated with\n the definition of menus of different types e.g. toolbars, menubars, popups etc.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _MenuItemOBJ.setDescription("The MenuItem is used to define triggerable menu items. You must specify\n either a displayLabel or a displayLabelI18N to indicate the label to be used for the\n menu item.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _FormBindingDefinitionOBJ.setDescription("The FormBinding class allows for the definition of bindings between DMO attributes\n and the editors that will be used to display and edit their values.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _EnumMappingGeneratorOBJ.setDescription("The EnumMappingGenerator definition allows for the specification of code\n generation extension that generates enum mapping code for a particular widget set.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _definedInModuleOBJ.setDescription("All MvwDefinitions are defined in an Module file that\n ends with a .mvw extension.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _handlesEventOBJ.setDescription("This attributes holds a list of MvwEvents that are\n handled by various MVW components.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _dependsOnModuleOBJ.setDescription("This attribute allows a Module to refer to other Modules\n on which it depends.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _selectedDMOOBJ.setDescription("This attribute indicates the class of DMO that is selected by a \n SingleDMOSelectedEvent.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _useBaseClassOBJ.setDescription("The useBaseClass attribute is used to specify the class from which a\n generated component class should be derived. It should be fully qualified name of a\n class.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _widgetOBJ.setDescription("Indicates if a View interface extends IsWidget. This defaults to true because\n most of our views will be displayed in a manner where implementing IsWidget is useful.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _displayDMOOBJ.setDescription("Indicates data to be displayed in a View. The attributes takes the form\n Class SINGLE|MULTI varname.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _broadcastOBJ.setDescription("Indicates an event that a View will first call on its Presenter interface and then\n broadcast on the event bus.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _broadcastOnlyOBJ.setDescription("Indicates an event tha a View will broadcast only on the event bus; it is not \n sent to its presenter.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _presenterMethodOBJ.setDescription("Indicates a local function name (on the Presenter), optionally followed by an argument vector\n and, if required fully qualified class names.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _viewMethodOBJ.setDescription("Indicates a local function name (on the View), optionally followed by an argument vector\n and, if required fully qualified class names.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _localOBJ.setDescription("Indicates that a View fires a local event to its Presenter. This is shorthand\n for a call to a member function on the Presenter.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _useSchemaOBJ.setDescription("Indicates the schemas that a component uses. Your module must specify dependsOnSchema\n for the appropriate schemas.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _createOnDemandOBJ.setDescription("Indicates that a RunContextItem will be created on demand when requested\n from the RunContext.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _alwaysEnabledOBJ.setDescription("Indicates if the item is always enabled. If not, there will be a\n method generated that is called before the menu is shown to determine if the item\n is enabled/disabled.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _menuOrderOBJ.setDescription("Indicates the lorder in which a sub menu or menu item\n should be displayed in the menu.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _triggersActionOBJ.setDescription("Indicates the ActionBinding to be associated with a menu entry, button or\n other UI component.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _unsetValueOBJ.setDescription("The enum value that indicates when an enum is not set i.e. its attribute would\n be removed.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _tipsFromI18NOBJ.setDescription("Specifies that tool tips should also be retrieved from an I18N configuration.\n The convention is that a tool tip for an attribute is named [attribute_name]Tip");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _autoCreatedOBJ.setDescription("This attribute is used to flag defintions that are created automatically by\n the MVW infrastructure.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _useSingleEditorOBJ.setDescription("When dealing with indexed attributes, the default behaviour is to create a\n form binding with an editor instance for each index slot. However, in some cases, you\n want to use a single complex editor that handles the attribute. By setting useSingleEditor\n to true, the form binding will contain a single editor for an indexed attribute.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _centralAsyncErrorHandlerOBJ.setDescription("Indicates that a controller is the target for centralized handling of asyncronous\n code loading errors.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _mappingGeneratorOBJ.setDescription("A reference to the generator that will create the enum mapping code.\n <p/>\n An example of this can be seen in the dark-matter-gxt project.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _enumGeneratorClassOBJ.setDescription("The fully qualified Java class name of a class that implements the MvwEnumMappingGeneratorIF.\n <p/>\n An example of this can be seen in the dark-matter-gxt project.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _EventWithArgsOBJ.setDescription("The EventWithArgs type is used to handle definitions of events\n associated with various Model View Whatever components.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _MethodWithArgsOBJ.setDescription("The MethodWithArgs type is used to handle definitions of function calls\n associated with various Model View Whatever components.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _GetWithOptionsOBJ.setDescription("The GetWithOptions type is used to handle indications that\n a component will perform get operations.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _RequestWithOptionsOBJ.setDescription("The RequestWithOptions type is used to handle indications that\n a component will perform delete or set operations.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _RequestTypeWithOptionsOBJ.setDescription("The RequestTypeWithOptions type is used to handle indications that\n a component will send the specified request type and use the specified function\n to send/receieve.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _EditFieldOBJ.setName("EditField");
            _EditFieldOBJ.setDescription("The EditField type is used to specify compact mappings of attributes\n to their field type editors and optionally their labels and tool tips.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _EventSpecOBJ.setDescription("The EventSpec type is used to indicate the events to be generated when\n selection and deletion of objects takes place.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _OperationSpecOBJ.setDescription("The OperationSpec type is used to indicate the events to be generated when an object\n is associated with some operation e.g. clicked, modified, created etc.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _SelectionTypeEnumOBJ.setDescription("The SelectionTypeEnum indicates the selection mode of operations\n associated with object selection or object deletion.");
...
// Generated from: org.dmd.dmg.util.SchemaFormatter.getObjectAsCode(SchemaFormatter.java:548)
            ...
            _RequestOptionEnumOBJ.setDescription("The RequestOptionEnum indicates a set of modifiers that direct\n code generation for standard Dark Matter Protocol request handling.");
